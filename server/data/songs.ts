...
export const songLibrary: Song[] = [
  {
    ...
    stems: [
      { id: 1, file: 'DRUMS.wav', instrument: 'Drums', icon: '\u{1F941}', color: '#ff4444' },
      { id: 2, file: 'BASS.wav', instrument: 'Bass', icon: '\u{1F3B8}', color: '#00d4ff' },
      { id: 3, file: 'KEYS.wav', instrument: 'Keys', icon: '\u{1F3B9}', color: '#8b5cf6' },
      { id: 4, file: 'GTRS.wav', instrument: 'Guitar', icon: '\u{1F3B8}', color: '#ffd700' },
      { id: 5, file: 'VOCAL.wav', instrument: 'Vocals', icon: '\u{1F3A4}', color: '#ff00aa' },
    ],
  ...
  },
  {
    ...
    stems: [
      { id: 1, file: 'DRUMS.wav', instrument: 'Drums', icon: '\u{1F941}', color: '#ff4444' },
      { id: 2, file: 'BASS.wav', instrument: 'Bass', icon: '\u{1F3B8}', color: '#00d4ff' },
      { id: 3, file: 'GTRS.wav', instrument: 'Guitar', icon: '\u{1F3B8}', color: '#ffd700' },
      { id: 4, file: 'BVs.wav', instrument: 'Backing Vocals', icon: '\u{1F3A4}', color: '#9d4edd' },
      { id: 5, file: 'VOCAL.wav', instrument: 'Vocals', icon: '\u{1F3A4}', color: '#ff00aa' },
    ],
  ...
  },
  {
    ...
    stems: [
      ...
      { id: 2, file: 'BASS.wav', instrument: 'Bass', icon: '\u{1F3B8}', color: '#00d4ff' },
      { id: 3, file: 'KEYS.wav', instrument: 'Keys', icon: '\u{1F3B9}', color: '#8b5cf6' },
      { id: 4, file: 'BV1.wav', instrument: 'Backing Vocals', icon: '\u{1F3A4}', color: '#00ff88' },
      { id: 5, file: 'VOCAL.wav', instrument: 'Vocals', icon: '\u{1F3A4}', color: '#ff00aa' },
    ],
  ...
  },
  {
    ...
    stems: [
      ...
      { id: 2, file: 'bass.wav', instrument: 'Bass', icon: '\u{1F3B8}', color: '#00d4ff' },
      { id: 3, file: 'keys.wav', instrument: 'Keys', icon: '\u{1F3B9}', color: '#8b5cf6' },
      { id: 4, file: 'guitar.wav', instrument: 'Guitar', icon: '\u{1F3B8}', color: '#ffd700' },
      { id: 5, file: 'vocals.wav', instrument: 'Vocals', icon: '\u{1F3A4}', color: '#ff00aa' },
    ],
  ...
  },
  {
    ...
    stems: [
      { id: 1, file: 'DRUMS.wav', instrument: 'Drums', icon: '\u{1F941}', color: '#ff4444' },
      { id: 2, file: 'KEYS.wav', instrument: 'Keys', icon: '\u{1F3B9}', color: '#8b5cf6' },
      { id: 3, file: 'GTRS.wav', instrument: 'Guitar', icon: '\u{1F3B8}', color: '#ffd700' },
      { id: 4, file: 'BVs.wav', instrument: 'Backing Vocals', icon: '\u{1F3A4}', color: '#00ff88' },
      { id: 5, file: 'VOCAL.wav', instrument: 'Vocals', icon: '\u{1F3A4}', color: '#ff00aa' },
    ],
  ...
  },
  {
    ...
    stems: [
      { id: 1, file: 'DRUMS.wav', instrument: 'Drums', icon: '\u{1F941}', color: '#ff4444' },
      { id: 2, file: 'BASS.wav', instrument: 'Bass', icon: '\u{1F3B8}', color: '#00d4ff' },
      { id: 3, file: 'PIANO.wav', instrument: 'Piano', icon: '\u{1F3B9}', color: '#8b5cf6' },
      { id: 4, file: 'GTRS.wav', instrument: 'Guitar', icon: '\u{1F3B8}', color: '#ffd700' },
      { id: 5, file: 'VOCAL.wav', instrument: 'Vocals', icon: '\u{1F3A4}', color: '#ff00aa' },
    ],
  ...
  },
  {
    ...
    stems: [
      ...
      { id: 2, file: 'BASS.wav', instrument: 'Bass', icon: '\u{1F3B8}', color: '#00d4ff' },
      { id: 3, file: 'PIANO.wav', instrument: 'Piano', icon: '\u{1F3B9}', color: '#8b5cf6' },
      { id: 4, file: 'GTR.wav', instrument: 'Guitar', icon: '\u{1F3B8}', color: '#ffd700' },
      { id: 5, file: 'VOCAL.wav', instrument: 'Vocals', icon: '\u{1F3A4}', color: '#ff00aa' },
    ],
  ...
  },
  {
    ...
    stems: [
      ...
      { id: 2, file: 'BASS.wav', instrument: 'Bass', icon: '\u{1F3B8}', color: '#00d4ff' },
      { id: 3, file: 'GTRS.wav', instrument: 'Guitar', icon: '\u{1F3B8}', color: '#ffd700' },
      { id: 4, file: 'VOCALS.wav', instrument: 'Vocals', icon: '\u{1F3A4}', color: '#ff00aa' },
    ],
  ...
  },
  {
    ...
    stems: [
      { id: 1, file: 'drums.wav', instrument: 'Drums', icon: '\u{1F941}', color: '#ff4444' },
      { id: 2, file: 'bass.wav', instrument: 'Bass', icon: '\u{1F3B8}', color: '#00d4ff' },
      { id: 3, file: 'guitar.wav', instrument: 'Guitar', icon: '\u{1F3B8}', color: '#ffd700' },
      { id: 4, file: 'vocals.wav', instrument: 'Vocals', icon: '\u{1F3A4}', color: '#ff00aa' },
    ],
