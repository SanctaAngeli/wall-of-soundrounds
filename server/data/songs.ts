...
const wosLibrary: Song[] = [
  ...
  // ========== A BAND recording session (Apr 2026) ==========
  { id: 'a-little-respect', title: 'A Little Respect', artist: 'Erasure', year: 1988, difficulty: 'easy', genre: 'Synth-Pop',
    stems: baseStems(), extraStems: fullExtras(),
    wrongAnswers: ['Enjoy the Silence', 'Chains of Love', "Don't You Want Me"] },
  { id: 'a-sky-full-of-stars', title: 'A Sky Full of Stars', artist: 'Coldplay', year: 2014, difficulty: 'easy', genre: 'Alternative',
    stems: baseStems(), extraStems: fullExtras(),
    wrongAnswers: ['Paradise', 'Adventure of a Lifetime', 'The Nights'] },
  { id: 'all-night-long', title: 'All Night Long', artist: 'Lionel Richie', year: 1983, difficulty: 'easy', genre: 'Pop',
    stems: baseStems(), extraStems: fullExtras(),
    wrongAnswers: ['Dancing on the Ceiling', 'Hello', 'Celebration'] },
  { id: 'all-i-wanna-do', title: 'All I Wanna Do', artist: 'Sheryl Crow', year: 1993, difficulty: 'easy', genre: 'Pop Rock',
    stems: baseStems(), extraStems: fullExtras(),
    wrongAnswers: ['If It Makes You Happy', 'Soak Up the Sun', 'My Favorite Mistake'] },
  ...
  { id: 'bad-boys-for-life', title: 'Bad Boy for Life', artist: 'P. Diddy, Black Rob & Mark Curry', year: 2001, difficulty: 'medium', genre: 'Hip-Hop',
    stems: baseStems(), extraStems: fullExtras(),
    wrongAnswers: ['Mo Money Mo Problems', "Can't Nobody Hold Me Down", 'Shake Ya Tailfeather'] },
  { id: 'big-girls-dont-cry', title: "Big Girls Don't Cry", artist: 'Fergie', year: 2007, difficulty: 'easy', genre: 'Pop',
    stems: baseStems(), extraStems: fullExtras(),
    wrongAnswers: ['Glamorous', 'Umbrella', 'Bleeding Love'] },
  { id: 'big-poppa', title: 'Big Poppa', artist: 'The Notorious B.I.G.', year: 1994, difficulty: 'medium', genre: 'Hip-Hop',
    stems: baseStems(), extraStems: fullExtras(),
    wrongAnswers: ['Juicy', 'Hypnotize', 'Mo Money Mo Problems'] },
  ...
  { id: 'chandelier', title: 'Chandelier', artist: 'Sia', year: 2014, difficulty: 'easy', genre: 'Pop',
    stems: baseStems(), extraStems: fullExtras(),
    wrongAnswers: ['Cheap Thrills', 'Elastic Heart', 'Titanium'] },
  ...
  { id: 'girls-just-wanna-have-fun', title: 'Girls Just Want to Have Fun', artist: 'Cyndi Lauper', year: 1983, difficulty: 'easy', genre: 'Pop',
    stems: baseStems(), extraStems: fullExtras(),
    wrongAnswers: ['Time After Time', 'True Colors', 'She Bop'] },
  { id: 'good-vibrations', title: 'Good Vibrations', artist: 'The Beach Boys', year: 1966, difficulty: 'easy', genre: 'Pop Rock',
    stems: baseStems(), extraStems: fullExtras(),
    wrongAnswers: ["Wouldn't It Be Nice", 'California Girls', "Surfin' USA"] },
  ...
  { id: 'hey-ya', title: 'Hey Ya!', artist: 'OutKast', year: 2003, difficulty: 'easy', genre: 'Hip-Hop',
    stems: baseStems(), extraStems: fullExtras(),
    wrongAnswers: ['Ms. Jackson', 'The Way You Move', 'Roses'] },
  ...
  { id: 'loser', title: 'Loser', artist: 'Beck', year: 1993, difficulty: 'medium', genre: 'Alternative',
    stems: baseStems(), extraStems: fullExtras(),
    wrongAnswers: ["Where It's At", 'E-Pro', "Devils Haircut"] },
  ...
  { id: 'stand-by-me', title: 'Stand by Me', artist: 'Ben E. King', year: 1961, difficulty: 'easy', genre: 'Soul',
    stems: baseStems(), extraStems: fullExtras(),
    wrongAnswers: ['Spanish Harlem', 'Save the Last Dance for Me', 'Under the Boardwalk'] },
  ...
  { id: 'we-are-family', title: 'We Are Family', artist: 'Sister Sledge', year: 1979, difficulty: 'easy', genre: 'Disco',
    stems: baseStems(), extraStems: fullExtras(),
    wrongAnswers: ["He's the Greatest Dancer", 'Lost in Music', 'Thinking of You'] },
  ...
  { id: 'whatta-man', title: 'Whatta Man', artist: 'Salt-N-Pepa feat. En Vogue', year: 1993, difficulty: 'medium', genre: 'Hip-Hop',
    stems: baseStems(), extraStems: fullExtras(),
    wrongAnswers: ['Push It', 'Shoop', "Let's Talk About Sex"] },
